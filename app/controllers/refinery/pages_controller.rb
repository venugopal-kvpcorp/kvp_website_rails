module Refinery
  class PagesController < ::ApplicationController
    ...
    before_filter :no_index_legal_page
    ...
    def home
      @pardot_params = Pardot::TrackingCodes.code_for(:signup_pp_app)
      @salutation = user_account_load_data
      @current_page = Page.find_by_slug("home")
    ...
    def show
      @pardot_params = Pardot::TrackingCodes.code_for(:signup_pp_app)
      @salutation = user_account_load_data
      @current_page = (@page.parent.nil?) ? @page : @page.parent 
  ...
  protected
    ...
    def no_index_legal_page
      @noindex = true if ( (@page.legal_page? or @page.parent.legal_page?) rescue false)
    end
  end
end
