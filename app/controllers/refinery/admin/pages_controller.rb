module Refinery
  module Admin
    class PagesController < Refinery::AdminController
      ...
      before_filter :load_valid_templates, :only => [:edit, :new, :create, :index]
      ...
      def new
        ...
        set_default_page_attributes!
        #loading page parts for newly created page
        PagePart.for_layout_template(@page.layout_template).each_with_index do | page_part, index |
    ...
    protected
      def set_default_page_attributes!
