...
ActiveRecord::Schema.define(:version => 20141017104413) do
  ...
  create_table "refinery_page_parts", :force => true do |t|
    ...
    t.datetime "created_at",       :null => false
    t.datetime "updated_at",       :null => false
    t.string   "layout_templates"
  end

  add_index "refinery_page_parts", ["id"], :name => "index_refinery_page_parts_on_id"
  add_index "refinery_page_parts", ["refinery_page_id"], :name => "index_refinery_page_parts_on_refinery_page_id"

  create_table "refinery_page_texts", :force => true do |t|
    t.string   "key"
    t.text     "value"
    t.string   "page"
    t.integer  "position"
  ...
  create_table "refinery_pages", :force => true do |t|
    ...
    t.string   "hreflang_url"
    t.float    "sitemap_priority",       :default => 0.7,   :null => false
    t.boolean  "allow_repayment_widget", :default => false, :null => false
  ...
  create_table "refinery_people", :force => true do |t|
    ...
    t.datetime "created_at",                               :null => false
    t.datetime "updated_at",                               :null => false
    t.boolean  "management_team",       :default => false
    t.boolean  "directors",             :default => false
    t.string   "twitter_profile_link"
    t.string   "linkedin_profile_link"
  end

  create_table "refinery_press_releases", :force => true do |t|
    t.string   "title"
    t.text     "content"
    t.text     "link"
    t.integer  "position"
    t.datetime "created_at",      :null => false
    t.datetime "updated_at",      :null => false
    t.string   "published_place"
    t.date     "published_date"
  end

  create_table "refinery_qas", :force => true do |t|
    t.text     "question"
    t.text     "answer"
    t.integer  "position"
    t.datetime "created_at", :null => false
