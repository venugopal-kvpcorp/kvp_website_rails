...
Refinery::Pages.configure do |config|
  ...
  config.layout_template_whitelist = ["application", "legal_layout", "stand_alone_page", "borrowers_layout", "investors_layout", "home_layout", "stand_alone_ebook", "blog_layout", "how_it_works", "unsupported_browser_layout", "faq_layout"]
